<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true" CodeBehind="CreateClient.aspx.cs" Inherits="Vacation_Manager1.CreateClient" %>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:dropdownlist runat="server" ID="ddlType"  required CssClass="form-control" 
                                    DataSourceID="VacationDb" DataTextField="Name" DataValueField="OppId"></asp:dropdownlist>
                              
                                <asp:SqlDataSource ID="VacationDb" runat="server" 
